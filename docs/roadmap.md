...
and fifth renumberings cost them nothing. **Two in a row is the convention holding**, and the table
above stops growing on the day the last numbered ADR is superseded.
