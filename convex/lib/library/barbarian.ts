...
export const BARBARIAN: ClassLibrary = {
  ...
  base: {
    ...
    feats: [
      ...
      {
        name: 'Greataxe',
        text: 'Your two-handed swing, and the thing you will roll most often. Roll 1d20+STR+PROF to hit; on a hit it deals the damage below in slashing, plus 2 more while you are raging.',
        roll: '1d12+STR',
        level: null,
        catalogueKey: null,
      },
      {
        name: 'Handaxe',
        text: 'A hatchet light enough to throw twenty feet, for the turn when whatever you want to hit is on the far side of the room. Roll 1d20+STR+PROF to hit, thrown or in hand.',
        roll: '1d6+STR',
        level: null,
        catalogueKey: null,
      },
    ...
    berserker: {
      ...
      4: {
        ...
        feats: [
          ...
          {
            name: 'Greataxe',
            text: 'Your two-handed swing, and the thing you will roll most often. Roll 1d20+STR+PROF to hit; on a hit it deals the damage below in slashing, plus 2 more while you are raging. Roll it twice a turn now.',
            roll: '1d12+STR',
            level: null,
            catalogueKey: null,
          },
